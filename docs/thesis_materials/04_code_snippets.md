...
以下片段均来自生产实现基准 `054198dd5ff6cd761377066a3cc95daf010f039f`，不包含 legacy/deprecated 路径。行号以该基准为准。论文正文每个功能宜保留 8～15 行最能说明核心机制的代码，并配合运行截图；复杂分布式流程用流程图解释，不要连续粘贴大段代码。
