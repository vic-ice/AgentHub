-- change_029_recreate_model_capability_checks.sql
-- Recreate the model usability check ledger removed by change_028.
-- Validation is on-demand diagnostics only; it never gates production use.
