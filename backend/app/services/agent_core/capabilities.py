        ...
        if external.book_search:
            self._specs["book_search"] = CapabilitySpec(
                ...
                description=(
                    ...
                    "request emit exactly one book_search call whose query keeps "
                    "the discovery goal. Put independently requested discovery "
                    "dimensions as separate shortest catalog subject noun phrases "
                    "in themes (not prose or combined requirements) "
                    "so the owner can retrieve each dimension without another LLM "
                    "pass. reference_titles contains every "
