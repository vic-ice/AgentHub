        ...
        if external.book_search:
            self._specs["book_search"] = CapabilitySpec(
                ...
                description=(
                    ...
                    "request emit exactly one book_search call whose query preserves "
                    "the complete discovery goal. Put understood dimensions as "
                    "separate shortest catalog subject noun phrases in themes. Set "
